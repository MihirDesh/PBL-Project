...
{ 
    return (
        <Desktop1
            ...
            shape1Copy1="shape-1-copy-1.png" 
            pressStartToBegin={ 
                <React.Fragment>
                Press start 
                <br />
...
function Desktop (props) {
    const { title, s1X_Generated, place, shape11, shape1Copy1, pressStartToBegin } = props;
return( 
...
const OverlapGroup = styled.div` 
    ...
    border-radius: 13px;
    box-shadow: 0px 0px 33px 12px #00000040;
`;    
...
const Rectangle1 = styled.div`
    ...
    border-radius: 23px; 
    box-shadow: 0px 0px 35px 16px #00000052;
`;
